...
inline spdlog::logger::logger(
    ...
    , _last_err_time(0)
    , _msg_counter(1)  // message counter will start from 1. 0-message id will
                       // be reserved for controll messages
{
...
inline void spdlog::logger::set_pattern(
...
template <typename... Args>
inline void spdlog::logger::log_if(
    const bool flag, level::level_enum lvl, const char* msg) {
  if (flag) {
    log(lvl, msg);
  }
}
...
template <typename T>
inline void spdlog::logger::log_if(
    const bool flag, level::level_enum lvl, const T& msg) {
  if (flag) {
    log(lvl, msg);
  }
}
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::trace_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::trace, fmt, arg1, args...);
  }
}
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::debug_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::debug, fmt, arg1, args...);
  }
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::info_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::info, fmt, arg1, args...);
  }
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::warn_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::warn, fmt, arg1, args...);
  }
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::error_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::err, fmt, arg1, args...);
  }
...
template <typename Arg1, typename... Args>
inline void spdlog::logger::critical_if(
    const bool flag, const char* fmt, const Arg1& arg1, const Args&... args) {
  if (flag) {
    log(level::critical, fmt, arg1, args...);
  }
...
template <typename... Args>
inline void spdlog::logger::log(
    level::level_enum lvl, const wchar_t* fmt, const Args&... args) {
...
template <typename... Args>
inline void spdlog::logger::log_if(
    const bool flag, level::level_enum lvl, const wchar_t* msg) {
  if (flag) {
    log(lvl, msg);
  }
}
...
template <typename... Args>
inline void spdlog::logger::trace_if(
    const bool flag, const wchar_t* fmt, const Args&... args) {
  if (flag) {
    log(level::trace, fmt, args...);
  }
}
...
inline void spdlog::logger::_set_pattern(
    const std::string& pattern, pattern_time_type pattern_time) {
